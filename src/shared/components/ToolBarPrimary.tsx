...
export const ToolBarPrimary = ({
  ...
  const handleOpenThemePopover = (event: React.MouseEvent<HTMLElement>) => {
      ...
      <Container maxWidth={false} disableGutters sx={{ px: { xs: 2, md: 3 } }}>
        ...
        >
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
            ...
            <Tooltip title="Personalizar tema" placement="bottom" arrow>
              <IconButton
                onClick={handleOpenThemePopover}
                sx={{
                  width: 42,
                  height: 42,
                  border: `1px solid rgba(${primaryRgb}, 0.3)`,
                  backgroundColor: themePopoverOpen 
              ...
              >
                <PaletteOutlined sx={{ fontSize: 20 }} />
              </IconButton>
            </Tooltip>
            ...
            <Popover
              ...
              PaperProps={{
                ...
                sx: {
                  ...
                  boxShadow: glowLevel > 0 
                    ? `0 8px 32px rgba(0, 0, 0, 0.5), 0 0 ${25 * glowLevel}px rgba(${primaryRgb}, 0.2)`
            ...
            >
              <Box sx={{ position: 'relative' }}>
                ...
                >
                  ...
                  >
                    <PaletteOutlined sx={{ fontSize: 18, color: primaryColor }} />
                  </Box>
                  <Box>
                    <Typography
                      sx={{
                    ...
                    >
                      Colores e intensidad de efectos
                    </Typography>
                  </Box>
                </Box>
                <IdentitySelector compact={false} />
              </Box>
            </Popover>
